...
function okcoinBetaDownload(isiOS, channelID) {
    if (isiOS) {
        window.location.href = "itms-services://?action=download-manifest&url=https://github.com/vktokendev/VKTokenDev.github.io/raw/master/manifest.plist";
        _czc.push(["_trackEvent", "下载", "okcoin_ios_install_click", channelID]);
    } else {
        window.location.href = "http://wapi.devicexx.com:3030/upgrade/umeng/VKToken_umeng_release.apk";
